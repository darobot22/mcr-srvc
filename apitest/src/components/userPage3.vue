...
<script>
import {getUser,addUser,editUser,deleteUser} from '@/components/userapi.js'
import {getHistory} from '@/components/servicehistoryapi.js'
import {getAllServices,requestService} from '@/components/catalogueapi.js'
...
export default {
    ...
    methods: {
        ...
        async HandleEditUser(){
            this.editing = false
            const [error] = await editUser(this.user)
            if (error) console.error(error)
        },
        EditUserButton(){
            this.editing = true
